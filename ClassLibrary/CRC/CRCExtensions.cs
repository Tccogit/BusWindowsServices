...
namespace ClassLibrary.CRC
{
    public static class CRCExtensions
    {
        ...
        /* message to calculate CRC upon quantity of bytes in message */
        {
            int dataLength = data.Length;
            UInt16 Counter = 0;
            byte uchCRCHi = 0xFF; /* high CRC byte initialized */
            byte uchCRCLo = 0xFF; /* low CRC byte initialized */
            byte uIndex; /* will index into CRC lookup*/
                         /* table */
            while ((dataLength--) != 0) /* pass through message buffer */
            {
                uIndex = (byte)(uchCRCHi ^ data[Counter++]); /* calculate the CRC */
